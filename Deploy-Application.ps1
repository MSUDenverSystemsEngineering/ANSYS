...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\Post\setup.exe" -Parameters "-silent -disablerss -licserverinfo `"::vmwas22.winad.msudenver.edu`" -nohelp" -PassThru
